...
HD_PWD='D:/CESE/5B2025/MyS/trabajo_final/Sintesis/spi_master.runs/spi_master_spi_master_ip_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_master_spi_master_ip_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_master_spi_master_ip_1_0.tcl
