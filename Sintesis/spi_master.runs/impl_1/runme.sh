...
HD_PWD='D:/CESE/5B2025/MyS/trabajo_final/Sintesis/spi_master.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_master_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_master_wrapper.tcl -notrace
