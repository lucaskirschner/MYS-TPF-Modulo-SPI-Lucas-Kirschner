...
HD_PWD='D:/CESE/5B2025/MyS/trabajo_final/Sintesis/spi_master.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_master_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_master_wrapper.tcl
