...
################################################################
# This is a generated script based on design: spi_master
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: spi_master_ip_1, and set properties
  set spi_master_ip_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:spi_master_ip:1.0 spi_master_ip_1 ]

  # Create interface connections
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins spi_master_ip_1/S_AXI]

  # Create port connections
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins clk_wiz/clk_out1] [get_bd_pins ila_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins spi_master_ip_1/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins spi_master_ip_1/s_axi_aresetn]
  connect_bd_net -net spi_master_ip_1_spi_clk_o [get_bd_pins ila_0/probe0] [get_bd_pins spi_master_ip_1/spi_clk_o]
  connect_bd_net -net spi_master_ip_1_spi_cs_o [get_bd_pins ila_0/probe2] [get_bd_pins spi_master_ip_1/spi_cs_o]
  connect_bd_net -net spi_master_ip_1_spi_mosi_o [get_bd_pins ila_0/probe1] [get_bd_pins spi_master_ip_1/spi_miso_i] [get_bd_pins spi_master_ip_1/spi_mosi_o]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz/clk_in1]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs spi_master_ip_1/S_AXI/S_AXI_reg] SEG_spi_master_ip_1_S_AXI_reg
