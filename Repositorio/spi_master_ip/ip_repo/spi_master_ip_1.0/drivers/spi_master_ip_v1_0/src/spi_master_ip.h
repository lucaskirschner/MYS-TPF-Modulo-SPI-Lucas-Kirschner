...
#define SPI_MASTER_IP_S_AXI_SLV_REG0_OFFSET 0
#define SPI_MASTER_IP_S_AXI_SLV_REG1_OFFSET 4
#define SPI_MASTER_IP_S_AXI_SLV_REG2_OFFSET 8
#define SPI_MASTER_IP_S_AXI_SLV_REG3_OFFSET 12
#define SPI_MASTER_IP_S_AXI_SLV_REG4_OFFSET 16
